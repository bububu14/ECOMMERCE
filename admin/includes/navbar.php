<header class="main-header" >
  <!-- Logo -->
  <a href="#" class="logo" style="background-color: #EB984E !important">
    <!-- mini logo for sidebar mini 50x50 pixels -->
    <span class="logo-mini"><b>E</b>FORM</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>ECO-</b>FORM</span>
  </a>
  <!-- Header Navbar: style can be found in header.less -->
  <nav class="navbar navbar-static-top" style="background-color: #EB984E !important">
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu" style="background-color: #EB984E !important">
          ...
          <ul class="dropdown-menu" style="background-color: #EB984E !important">
            <!-- User image -->
