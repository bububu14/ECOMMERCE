...
<div class="wrapper"style="background-color: #EB984E !important">

  <?php include 'includes/navbar.php'; ?>
  <?php include 'includes/menubar.php'; ?>

  <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper" style="background-color: #EB984E !important" >
    <!-- Content Header (Page header) -->
    <section class="content-header" >
      <h1>
        Dashboard
      </h1>
      <ol class="breadcrumb" style="background-color: #EB984E !important">
    ...
    <!-- Main content -->
    <section class="content" style="background-color: #EB984E !important">
      <?php
